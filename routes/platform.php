...
use App\Orchid\Screens\Vehicle\VehicleListScreen;
use App\Orchid\Screens\Vehicle\VehicleEditScreen;
use App\Orchid\Screens\Device\DeviceListScreen;
use App\Orchid\Screens\Device\DeviceEditScreen;
...
// Platform > System > Companies > Company
...
->breadcrumbs(fn (Trail $trail, $device) => $trail
    ...
    ->push($device->name, route('platform.systems.devices.edit', $device)));

// Platform > System > Vehicles
Route::screen('vehicles', VehicleListScreen::class)
    ->name('platform.systems.vehicles')
    ->breadcrumbs(fn (Trail $trail) => $trail
    ->parent('platform.index')
    ->push(__('Vehicles'), route('platform.systems.vehicles')));

// Platform > System > Vehicles > Vehicle
Route::screen('vehicles/{vehicle}/edit', VehicleEditScreen::class)
    ->name('platform.systems.vehicles.edit')
    ->breadcrumbs(fn (Trail $trail, $vehicle) => $trail
        ->parent('platform.systems.vehicles')
        ->push($vehicle->name, route('platform.systems.vehicles.edit', $vehicle)));
